class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
  def up
    ...
    content = {:metadata => {:jsonld => "true", :program => "academy", :header => "", 
            ...
            {:url => "#faq", :text => "FAQ"}]},
        :banner => { :breadcrumb => [{:cta => "Home", :link => "https://www.scaler.com/"},{:cta => "<b>Academy</b>", :link => "https://www.scaler.com/academy/"},{:cta => "<b>System Design</b>"}], :heading => "<h1><b>Learn System Design Fundamentals and Build Systems At Scale</b></h1>", 
    ...
    :testimonials => {:heading => "<h2>Our success <span class=\"highlight\">lies in our learners</span> success stories.</h2>", 
        ...
        :tuition_fee => {:heading => "<b>Tuition Fee of <span class='highlight'>Scaler Academy Program<span><b>", :title_img => "academy/svg/money-logo.svg", 
            :subtitle => "Total fee: Rs 3.19L inclusive of GST. You can get super 
            affordable EMI options. Try the course for the first 2 weeks - full money-back guarantee 
            if you choose to withdraw.", :title_content => "With EMI options, your payment can be as low as 10,492 per month- that's like your monthly grocery bill!", 
