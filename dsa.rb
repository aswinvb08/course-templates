  ...
  def up
    ...
    Course.find_by(:slug => "data-structures-and-algorithms")&.destroy
          ...
          :sections=>[
              ...
              :modules=>[
                {
                  ...
                  :content=>{
                    ...
                    :read_next=>"Read Next: Module 2 -  Data Structures and Algorithms"
                  }
                }, 
                {
                  :label=>"Module - 2", 
                    ...
                    :module_detail_pointers=>[
                      {
                        ...
                        :module_detail_pointers_detail=>[
                          ...
                          {
                            :name=>"Introduction to Time complexity", 
                            :module_detail_pointers_details=>[]
                          }, 
                          {
                          ...
                          {
                            :name=>"Introduction to Sorting & Hashing", 
                            :module_detail_pointers_details=>[]
                          }, 
                          {
                          ...
                          {
                            :name=>"Stacks, Linked List, Trees, Tries and Heaps", 
                            :module_detail_pointers_details=>[]
                          }
                        ]
                      }
                    ], 
                    :read_next=>"Read Next: Module 3 - SQL"
                  }
                  }, 
                  {
                  :label=>"Module - 3", 
                    ...
                    :module_detail_pointers=>[
                      {
                        ...
                        :module_detail_pointers_detail=>[
                          ...
                          {
                            :name=>"Joins", :module_detail_pointers_details=>[]
                          }, 
                          {
                            :name=>"Aggregation", 
                            :module_detail_pointers_details=>[]
                  ...
                  :content=>{
                    ...
                    :module_detail_pointers=>[
                      ...
                      }, 
                      {
                        ...
                        :module_detail_pointers_detail=>[
                          {
                            :name=>"Advanced Language Fundamentals", 
                            :module_detail_pointers_details=>[]
                          }, 
                          {
                            :name=>"Concurrency", 
                          ...
                          {
                            :name=>"Postman, Monitoring, Logging ", 
                            :module_detail_pointers_details=>[]
                          }, 
                          {
                            :name=>"Testing", 
                    ...
                    :read_next=>"Read Next: Module 5 - System Design Essentials"
                  }
                  }, 
                  {
                  :label=>"Module - 5", 
                  ...
                  :content=>{
                    ...
                    :module_detail_pointers=>[
                      ...
                      {
                        :name=>"Scalability case studies (LLD + HLD)", 
                        :module_detail_pointers_detail=>[]
                      }
                    ], 
                    :read_next=>"Read Next: System Design Electives"
                  }
                  }, 
                  {
                  :label=>"", 
                  :name=>"System Design Electives", 
                  :duration=>"3 Months", 
                  :content=>{
                    :duration=>"3 Months", 
                    :module_detail_pointers=>[
                    ...
                    :read_prev=>"Read Prev: Module 1 - Programming Language Fundamentals"
                  }
                }
              ]
            }, 
              ...
              :modules=>[
                {
                  ...
                  :content=>{
                    ...
                    :read_next=>"Read Next: Module 2 - Advanced DSA and CS Fundamentals"
                  }
                  }, 
                  {
                    :label=>"Module - 2", 
                    ...
                    :read_next=>"Read Next: Module 3 - Software and System Design"
                  }
                }, 
              {
                :label=>"Module - 3", 
                  ...
                  :module_detail_pointers=>[
                    {
                      ...
                      :module_detail_pointers_detail=>[
                        {
                          :name=>"OOP", :module_detail_pointers_details=>[]
                        }, 
                        {
                          :name=>"Design Principles - SOLID", 
                          :module_detail_pointers_details=>[]
                ...
                :read_next=>"Read Next: Specializations"
              }
            }, 
            {
              :label=>"", 
              ...
              :content=>{
                ...
                :module_detail_pointers=>[
                  ...
                  {
                    :name=>"ORM", :module_detail_pointers_detail=>[]
                  }, 
                  {
                  ...
                  {
                    :name=>"Advanced SQL", :module_detail_pointers_detail=>[]
                  }, 
                  {
            ...
            }, 
            {
              ...
              :content=>{
                ...
                :read_prev=>"Read Prev: Module 1 - Programming Constructs"
              }
            }
            ]
            }, 
            ...
            :modules=>[
              {
                ...
                :content=>{
                  ...
                  :module_detail_pointers=>[
                    {
                      ...
                      :module_detail_pointers_detail=>[
                        ...
                        {
                          :name=>"Arrays", :module_detail_pointers_details=>[]
                        }, 
                        {
                          :name=>"Bit Manipulation", :module_detail_pointers_details=>[]
                        }, 
                        {
                          :name=>"Maths", :module_detail_pointers_details=>[]
                        }, 
                        {
                          :name=>"Recursion & Sorting", 
                          :module_detail_pointers_details=>[]
                    ...
                    }, 
                    {
                      ...
                      :module_detail_pointers_detail=>[
                        ...
                        {
                          :name=>"Tries & Heaps", :module_detail_pointers_details=>[]
                        }
                      ]
                    }, 
                    {
                      ...
                      :module_detail_pointers_detail=>[
                        ...
                        {
                          :name=>"Graphs", :module_detail_pointers_details=>[]
                        }
                      ]
                    }, 
                    {
                  ...
                  :read_next=>"Read Next: Module 2 - Software and System Design"
                }
              }, 
              {
                :label=>"Module - 2", 
              ...
              }, 
              {
                ...
                :content=>{
                  ...
                  :module_detail_pointers=>[
                    ...
                    {
                      :name=>"Disjoint Set Union", :module_detail_pointers_detail=>[]
                    }, 
                    {
                      :name=>"Advanced Dynamic Programming", 
                      :module_detail_pointers_detail=>[]
      ...
      content.merge!(:tuition_fee => {:heading => "<b>Tuition Fee<b>", :title_img => "academy/svg/money-logo.svg", 
                  :subtitle => "Total fee: Rs 3.69L inclusive of GST at super affordable EMI options. Try the course for the first 2 weeks - full money-back guarantee if you choose to withdraw.", :title_content => "With EMI options, your payment can be as 
