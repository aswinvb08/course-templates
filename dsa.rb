      ...
      content.merge!(:academy_curriculum_2 => 
        {
          ...
          :sections=>[{:heading=>"Beginner", :duration=>"11 Months", :modules=>[{:label=>"Module - 1", :name=>"Programming Language Fundamentals", :duration=>"2 Months", :content=>{:duration=>"2 Months", :module_detail_pointers=>[{:name=>"Programming Language Fundamentals", :module_detail_pointers_detail=>[{:name=>"Java", :module_detail_pointers_details=>[]}, {:name=>"Data Types and Operators", :module_detail_pointers_details=>[]}, {:name=>"Loops and Conditional Statements", :module_detail_pointers_details=>[]}, {:name=>"Functions", :module_detail_pointers_details=>[]}, {:name=>"Strings", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Module 2 -  Data Structures and Algorithms"}}, {:label=>"Module - 2", :name=>" Data Structures and Algorithms", :duration=>"4.5 Months", :content=>{:duration=>"4.5 Months", :module_detail_pointers=>[{:name=>"Data Structures and Algorithms", :module_detail_pointers_detail=>[{:name=>"Introduction to Maths for Programming", :module_detail_pointers_details=>[]}, {:name=>"1D and 2D Arrays", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Time complexity", :module_detail_pointers_details=>[]}, {:name=>"Bit Manipulation", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Sorting & Hashing", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Recursion", :module_detail_pointers_details=>[]}, {:name=>"Stacks, Linked List, Trees, Tries and Heaps", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Module 3 - SQL"}}, {:label=>"Module - 3", :name=>"SQL", :duration=>"0.5 Months", :content=>{:duration=>"0.5 Months", :module_detail_pointers=>[{:name=>"SQL", :module_detail_pointers_detail=>[{:name=>"CRUD", :module_detail_pointers_details=>[]}, {:name=>"Joins", :module_detail_pointers_details=>[]}, {:name=>"Aggregation", :module_detail_pointers_details=>[]}, {:name=>"Indexing", :module_detail_pointers_details=>[]}, {:name=>"Transaction", :module_detail_pointers_details=>[]}, {:name=>"Advanced SQL", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Module 4 - Specializations"}}, {:label=>"Module - 4", :name=>"Specializations", :duration=>"3 Months", :content=>{:duration=>"3 Months", :duration_description=>"*Only 1 Specialization is allowed per learner, Recorded lectures for others can be availed through  'Request from Support'. At Least 1 specialization is mandatory for successful completion of the course.", :module_detail_pointers=>[{:name=>"Fullstack Engineering", :module_detail_pointers_detail=>[{:name=>"HTML + CSS", :module_detail_pointers_details=>[]}, {:name=>"JS", :module_detail_pointers_details=>[]}, {:name=>"Simple Projects", :module_detail_pointers_details=>[]}, {:name=>"API Design, CRUD", :module_detail_pointers_details=>[]}, {:name=>"React + Redux", :module_detail_pointers_details=>[]}, {:name=>"Project", :module_detail_pointers_details=>[]}, {:name=>"Express + Mongo", :module_detail_pointers_details=>[]}]}, {:choice=>"or", :module_detail_pointers_details=>[]}, {:name=>"Backend Engineering", :module_detail_pointers_detail=>[{:name=>"Advanced Language Fundamentals", :module_detail_pointers_details=>[]}, {:name=>"Concurrency", :module_detail_pointers_details=>[]}, {:name=>"SOLID, Design Patterns", :module_detail_pointers_details=>[]}, {:name=>"Schema Design, API Design", :module_detail_pointers_details=>[]}, {:name=>"Spring Boot + Projects", :module_detail_pointers_details=>[]}, {:name=>"Postman, Monitoring, Logging ", :module_detail_pointers_details=>[]}, {:name=>"Testing", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Module 5 - System Design Essentials"}}, {:label=>"Module - 5", :name=>"System Design Essentials", :duration=>"1 Months", :content=>{:duration=>"1 Months", :module_detail_pointers=>[{:title=>"System Design Essentials", :module_detail_pointers_detail=>[]}, {:name=>"CDN", :module_detail_pointers_detail=>[]}, {:name=>"SQL", :module_detail_pointers_detail=>[]}, {:name=>"NoSQL", :module_detail_pointers_detail=>[]}, {:name=>"Caches", :module_detail_pointers_detail=>[]}, {:name=>"Queues", :module_detail_pointers_detail=>[]}, {:name=>"Scalability case studies (LLD + HLD)", :module_detail_pointers_detail=>[]}], :read_next=>"Read Next: Electives"}}, {:label=>"", :name=>"Electives", :duration=>"1-3 Months", :content=>{:duration=>"1-3 Months", :module_detail_pointers=>[{:name=>"Advanced Software &  System Design - 1.5 months", :module_detail_pointers_detail=>[{:name=>"Zookeeper + Kafka", :module_detail_pointers_details=>[]}, {:name=>"Location Based Services (S3, Quad Trees)", :module_detail_pointers_details=>[]}, {:name=>"Microservices & Containerisation (Docker)", :module_detail_pointers_details=>[]}, {:name=>"Case Studies", :module_detail_pointers_details=>[]}]}, {:choice=>"And/Or", :module_detail_pointers_detail=>[]}, {:name=>"Data Engineering - 2 months", :module_detail_pointers_detail=>[{:name=>"Building efficient Data Processing Systems", :module_detail_pointers_details=>[]}, {:name=>"Advanced SQL", :module_detail_pointers_details=>[]}, {:name=>"Cloud Services - AWS, or GCP", :module_detail_pointers_details=>[]}, {:name=>"Developing ETL pipelines", :module_detail_pointers_details=>[]}, {:name=>"Map-Reduce Framework", :module_detail_pointers_details=>[]}, {:name=>"Big Data", :module_detail_pointers_details=>[]}, {:name=>"Data Warehousing & Modelling", :module_detail_pointers_details=>[]}, {:name=>"OLAP, Dashboarding", :module_detail_pointers_details=>[]}, {:name=>"Workflow Orchestration", :module_detail_pointers_details=>[]}, {:name=>"Logging, and Monitoring", :module_detail_pointers_details=>[]}, {:name=>"MapReduce, HiveQL, Presto", :module_detail_pointers_details=>[]}, {:name=>"3 Projects", :module_detail_pointers_details=>[]}]}, {:choice=>"And/Or", :module_detail_pointers_detail=>[]}, {:name=>"Advanced DSA for Competitive Programming - 1 month", :module_detail_pointers_detail=>[{:name=>"Combinatorics and Probability", :module_detail_pointers_details=>[]}, {:name=>"Matrix exponentiation", :module_detail_pointers_details=>[]}, {:name=>"Advanced Trees: Segment Tree, k-D Tree", :module_detail_pointers_details=>[]}, {:name=>"Disjoint Set Union", :module_detail_pointers_details=>[]}, {:name=>"Advanced Dynamic Programming", :module_detail_pointers_details=>[]}, {:name=>"Advanced Graphs: Bridges, Articulation point, Network Flow", :module_detail_pointers_details=>[]}]}, {:choice=>"And/Or", :module_detail_pointers_detail=>[]}, {:name=>"Product Management for Engineers  - 1 month", :module_detail_pointers_detail=>[{:name=>"Introduction to Product Management", :module_detail_pointers_details=>[]}, {:name=>"Product Thinking & Product Discovery", :module_detail_pointers_details=>[]}, {:name=>"Product Roadmap & Prioritization", :module_detail_pointers_details=>[]}, {:name=>"Mental Models for Product Managers", :module_detail_pointers_details=>[]}, {:name=>"Product Analytics", :module_detail_pointers_details=>[]}, {:name=>"Hands-on case study & Mixpanel session", :module_detail_pointers_details=>[]}, {:name=>"Delivery & Project Management", :module_detail_pointers_details=>[]}, {:name=>"Practical ways to apply PM lessons as an Engineer", :module_detail_pointers_details=>[]}]}], :read_prev=>"Read Prev: Module 1 - Programming Language Fundamentals"}}]}, {:heading=>"Intermediate", :duration=>"11 Months", :modules=>[{:label=>"Module - 1", :name=>"Programming Constructs", :duration=>"2 Months", :content=>{:duration=>"2 Months", :module_detail_pointers=>[{:name=>"Programming Constructs", :module_detail_pointers_detail=>[{:name=>"Introduction to Time Complexity Analysis", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Arrays", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Number System, Bit Manipulation", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Maths for Programming", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Sorting and Hashing", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Recursion", :module_detail_pointers_details=>[]}, {:name=>"Introduction to Data Structures Fundamentals (Stacks, Linked Lists, Trees)", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Module 2 - Advanced DSA and CS Fundamentals"}}, {:label=>"Module - 2", :name=>"Advanced DSA and CS Fundamentals", :duration=>"4 Months", :content=>{:duration=>"4 Months", :module_detail_pointers=>[{:name=>"Problem Solving Techniques", :module_detail_pointers_detail=>[{:name=>"Time Complexity Analysis", :module_detail_pointers_details=>[]}, {:name=>"Arrays", :module_detail_pointers_details=>[]}, {:name=>"Bit Manipulation", :module_detail_pointers_details=>[]}, {:name=>"Maths", :module_detail_pointers_details=>[]}, {:name=>"Recursion & Sorting", :module_detail_pointers_details=>[]}, {:name=>"Binary Search & 2 Pointers", :module_detail_pointers_details=>[]}, {:name=>"Hashing", :module_detail_pointers_details=>[]}, {:name=>"Pattern Matching Algorithms", :module_detail_pointers_details=>[]}]}, {:name=>"Data Structures", :module_detail_pointers_detail=>[{:name=>"Linked Lists", :module_detail_pointers_details=>[]}, {:name=>"Stacks & Queues", :module_detail_pointers_details=>[]}, {:name=>"Trees", :module_detail_pointers_details=>[]}, {:name=>"Tries & Heaps", :module_detail_pointers_details=>[]}]}, {:name=>"Advanced Problem Solving Techniques", :module_detail_pointers_detail=>[{:name=>"Greedy Algorithms", :module_detail_pointers_details=>[]}, {:name=>"Backtracking", :module_detail_pointers_details=>[]}, {:name=>"Dynamic Programming", :module_detail_pointers_details=>[]}, {:name=>"Graphs", :module_detail_pointers_details=>[]}]}, {:name=>"Programming Language Internals**", :description=>"(To be conducted in inverted classroom model)", :module_detail_pointers_detail=>[{:name=>"Data Types and Syntax", :module_detail_pointers_details=>[]}, {:name=>"Programming Paradigms for the Language", :module_detail_pointers_details=>[]}, {:name=>"Collections framework/ standard library", :module_detail_pointers_details=>[]}, {:name=>"Concurrency", :module_detail_pointers_details=>[]}, {:name=>"Advanced Concepts and Common Pitfalls", :module_detail_pointers_details=>[]}]}, {:name=>"Database Management Systems", :module_detail_pointers_detail=>[{:name=>"SQL", :module_detail_pointers_details=>[]}]}, {:name=>"Operating Systems", :module_detail_pointers_detail=>[{:name=>"Concurrency and Synchronization", :module_detail_pointers_details=>[]}]}, {:name=>"Computer Networks", :module_detail_pointers_detail=>[{:name=>"Socket Programming", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Module 3 - Software and System Design"}}, {:label=>"Module - 3", :name=>"Software and System Design", :duration=>"3 Months", :content=>{:duration=>"3 Months", :module_detail_pointers=>[{:name=>"Object Oriented Design (LLD)", :module_detail_pointers_detail=>[{:name=>"OOP", :module_detail_pointers_details=>[]}, {:name=>"Design Principles - SOLID", :module_detail_pointers_details=>[]}, {:name=>"Design Patterns", :module_detail_pointers_details=>[]}, {:name=>"UML Diagrams & Schema Design", :module_detail_pointers_details=>[]}, {:name=>"Best Programming Practices (API Design and Project Structure)", :module_detail_pointers_details=>[]}, {:name=>"Concurrency and Multithreading", :module_detail_pointers_details=>[]}, {:name=>"Case Studies and Machine Coding (How to build real systems)", :module_detail_pointers_details=>[]}]}, {:name=>"System Design (HLD)", :module_detail_pointers_detail=>[{:name=>"Consistent Hashing", :module_detail_pointers_details=>[]}, {:name=>"Caching", :module_detail_pointers_details=>[]}, {:name=>"CAP Theorem", :module_detail_pointers_details=>[]}, {:name=>"Distributed Systems & Databases", :module_detail_pointers_details=>[]}, {:name=>"SQL and NoSQL", :module_detail_pointers_details=>[]}, {:name=>"Scalability", :module_detail_pointers_details=>[]}, {:name=>"Zookeeper + Kafka", :module_detail_pointers_details=>[]}, {:name=>"Location Based Services (S3, Quad Trees)", :module_detail_pointers_details=>[]}, {:name=>"Microservices & Containerisation (Docker)", :module_detail_pointers_details=>[]}, {:name=>"Case Studies", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Specializations"}}, {:label=>"", :name=>"Specializations", :duration=>"2 Months", :content=>{:duration=>"2 Months", :module_detail_pointers=>[{:title=>"FullStack Specialisation (Backend and Fullstack)", :module_detail_pointers_detail=>[]}, {:name=>"MVC", :module_detail_pointers_detail=>[]}, {:name=>"REST APIs", :module_detail_pointers_detail=>[]}, {:name=>"ORM", :module_detail_pointers_detail=>[]}, {:name=>"SpringBoot (or Django)", :module_detail_pointers_detail=>[]}, {:name=>"Views", :module_detail_pointers_detail=>[]}, {:name=>"Building a server", :module_detail_pointers_detail=>[]}, {:name=>"Web architecture", :module_detail_pointers_detail=>[]}, {:name=>"HTML, CSS, Javascript in depth, Node.js", :module_detail_pointers_detail=>[]}, {:name=>"Backend architecture, MongoDB, React / Redux", :module_detail_pointers_detail=>[]}, {:name=>"Github, Version Control", :module_detail_pointers_detail=>[]}, {:name=>"Capstone project", :module_detail_pointers_detail=>[]}, {:choice=>"Or", :module_detail_pointers_detail=>[]}, {:title=>"Data Engineering Specialisation", :module_detail_pointers_detail=>[]}, {:name=>"Building efficient Data Processing Systems", :module_detail_pointers_detail=>[]}, {:name=>"Advanced SQL", :module_detail_pointers_detail=>[]}, {:name=>"Cloud Services - AWS, or GCP", :module_detail_pointers_detail=>[]}, {:name=>"Developing ETL pipelines", :module_detail_pointers_detail=>[]}, {:name=>"Map-Reduce Framework", :module_detail_pointers_detail=>[]}, {:name=>"Big Data", :module_detail_pointers_detail=>[]}, {:name=>"Data Warehousing & Modelling", :module_detail_pointers_detail=>[]}, {:name=>"OLAP, Dashboarding", :module_detail_pointers_detail=>[]}, {:name=>"Workflow Orchestration", :module_detail_pointers_detail=>[]}, {:name=>"Logging, and Monitoring", :module_detail_pointers_detail=>[]}, {:name=>"MapReduce, HiveQL, Presto", :module_detail_pointers_detail=>[]}, {:name=>"3 Projects", :module_detail_pointers_detail=>[]}], :read_next=>"Read Next: Advanced Electives"}}, {:label=>"", :name=>"Advanced Electives", :duration=>"1 Month", :content=>{:duration=>"1 Month", :module_detail_pointers=>[{:title=>"DSA for Competitive Programming", :module_detail_pointers_detail=>[]}, {:name=>"Combinatorics and Probability", :module_detail_pointers_detail=>[]}, {:name=>"Matrix exponentiation", :module_detail_pointers_detail=>[]}, {:name=>"Advanced Trees: Segment Tree, k-D Tree", :module_detail_pointers_detail=>[]}, {:name=>"Disjoint Set Union", :module_detail_pointers_detail=>[]}, {:name=>"Advanced Dynamic Programming", :module_detail_pointers_detail=>[]}, {:name=>"Advanced Graphs: Bridges, Articulation point, Network Flow ", :module_detail_pointers_detail=>[]}, {:choice=>"And/Or", :module_detail_pointers_detail=>[]}, {:title=>"Product Management for Engineers", :module_detail_pointers_detail=>[]}, {:name=>"Introduction to Product Management", :module_detail_pointers_detail=>[]}, {:name=>"Product Thinking & Product Discovery", :module_detail_pointers_detail=>[]}, {:name=>"Product Roadmap & Prioritization", :module_detail_pointers_detail=>[]}, {:name=>"Mental Models for Product Managers", :module_detail_pointers_detail=>[]}, {:name=>"Product Analytics", :module_detail_pointers_detail=>[]}, {:name=>"Hands-on case study & Mixpanel session", :module_detail_pointers_detail=>[]}, {:name=>"Delivery & Project Management", :module_detail_pointers_detail=>[]}, {:name=>"Practical ways to apply PM lessons as an Engineer", :module_detail_pointers_detail=>[]}], :read_prev=>"Read Prev: Module 1 - Programming Constructs"}}]}, {:heading=>"Advanced", :duration=>"09 Months", :modules=>[{:label=>"Module - 1", :name=>"Advanced DSA and CS Fundamentals", :duration=>"4 Months", :content=>{:duration=>"4 Months", :module_detail_pointers=>[{:name=>"Problem Solving Techniques", :module_detail_pointers_detail=>[{:name=>"Time Complexity Analysis", :module_detail_pointers_details=>[]}, {:name=>"Arrays", :module_detail_pointers_details=>[]}, {:name=>"Bit Manipulation", :module_detail_pointers_details=>[]}, {:name=>"Maths", :module_detail_pointers_details=>[]}, {:name=>"Recursion & Sorting", :module_detail_pointers_details=>[]}, {:name=>"Binary Search & 2 Pointers", :module_detail_pointers_details=>[]}, {:name=>"Hashing", :module_detail_pointers_details=>[]}, {:name=>"Pattern Matching Algorithms", :module_detail_pointers_details=>[]}]}, {:name=>"Data Structures", :module_detail_pointers_detail=>[{:name=>"Linked Lists", :module_detail_pointers_details=>[]}, {:name=>"Stacks & Queues", :module_detail_pointers_details=>[]}, {:name=>"Trees", :module_detail_pointers_details=>[]}, {:name=>"Tries & Heaps", :module_detail_pointers_details=>[]}]}, {:name=>"Advanced Problem Solving Techniques", :module_detail_pointers_detail=>[{:name=>"Greedy Algorithms", :module_detail_pointers_details=>[]}, {:name=>"Backtracking", :module_detail_pointers_details=>[]}, {:name=>"Dynamic Programming", :module_detail_pointers_details=>[]}, {:name=>"Graphs", :module_detail_pointers_details=>[]}]}, {:name=>"Programming Language Internals**", :description=>"(To be conducted in inverted classroom model)", :module_detail_pointers_detail=>[{:name=>"Data Types and Syntax", :module_detail_pointers_details=>[]}, {:name=>"Programming Paradigms for the Language", :module_detail_pointers_details=>[]}, {:name=>"Collections framework/ standard library", :module_detail_pointers_details=>[]}, {:name=>"Concurrency", :module_detail_pointers_details=>[]}, {:name=>"Advanced Concepts and Common Pitfalls", :module_detail_pointers_details=>[]}]}, {:name=>"Database Management Systems", :module_detail_pointers_detail=>[{:name=>"SQL", :module_detail_pointers_details=>[]}]}, {:name=>"Operating Systems", :module_detail_pointers_detail=>[{:name=>"Concurrency and Synchronization", :module_detail_pointers_details=>[]}]}, {:name=>"Computer Networks", :module_detail_pointers_detail=>[{:name=>"Socket Programming", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Module 2 - Software and System Design"}}, {:label=>"Module - 2", :name=>"Software and System Design", :duration=>"3 Months", :content=>{:duration=>"3 Months", :module_detail_pointers=>[{:name=>"Object Oriented Design (LLD)", :module_detail_pointers_detail=>[{:name=>"OOP", :module_detail_pointers_details=>[]}, {:name=>"Design Principles - SOLID", :module_detail_pointers_details=>[]}, {:name=>"Design Patterns", :module_detail_pointers_details=>[]}, {:name=>"UML Diagrams & Schema Design", :module_detail_pointers_details=>[]}, {:name=>"Best Programming Practices (API Design and Project Structure)", :module_detail_pointers_details=>[]}, {:name=>"Concurrency and Multithreading", :module_detail_pointers_details=>[]}, {:name=>"Case Studies and Machine Coding (How to build real systems)", :module_detail_pointers_details=>[]}]}, {:name=>"System Design (HLD)", :module_detail_pointers_detail=>[{:name=>"Consistent Hashing", :module_detail_pointers_details=>[]}, {:name=>"Caching", :module_detail_pointers_details=>[]}, {:name=>"CAP Theorem", :module_detail_pointers_details=>[]}, {:name=>"Distributed Systems & Databases", :module_detail_pointers_details=>[]}, {:name=>"SQL and NoSQL", :module_detail_pointers_details=>[]}, {:name=>"Scalability", :module_detail_pointers_details=>[]}, {:name=>"Zookeeper + Kafka", :module_detail_pointers_details=>[]}, {:name=>"Location Based Services (S3, Quad Trees)", :module_detail_pointers_details=>[]}, {:name=>"Microservices & Containerisation (Docker)", :module_detail_pointers_details=>[]}, {:name=>"Case Studies", :module_detail_pointers_details=>[]}]}], :read_next=>"Read Next: Specializations"}}, {:label=>"", :name=>"Specializations", :duration=>"2 Months", :content=>{:duration=>"2 Months", :module_detail_pointers=>[{:title=>"FullStack Specialisation (Backend and Fullstack)", :module_detail_pointers_detail=>[]}, {:name=>"MVC", :module_detail_pointers_detail=>[]}, {:name=>"REST APIs", :module_detail_pointers_detail=>[]}, {:name=>"ORM", :module_detail_pointers_detail=>[]}, {:name=>"SpringBoot (or Django)", :module_detail_pointers_detail=>[]}, {:name=>"Views", :module_detail_pointers_detail=>[]}, {:name=>"Building a server", :module_detail_pointers_detail=>[]}, {:name=>"Web architecture", :module_detail_pointers_detail=>[]}, {:name=>"HTML, CSS, Javascript in depth, Node.js", :module_detail_pointers_detail=>[]}, {:name=>"Backend architecture, MongoDB, React / Redux", :module_detail_pointers_detail=>[]}, {:name=>"Github, Version Control", :module_detail_pointers_detail=>[]}, {:name=>"Capstone project", :module_detail_pointers_detail=>[]}, {:choice=>"Or", :module_detail_pointers_detail=>[]}, {:title=>"Data Engineering Specialisation", :module_detail_pointers_detail=>[]}, {:name=>"Building efficient Data Processing Systems", :module_detail_pointers_detail=>[]}, {:name=>"Advanced SQL", :module_detail_pointers_detail=>[]}, {:name=>"Cloud Services - AWS, or GCP", :module_detail_pointers_detail=>[]}, {:name=>"Developing ETL pipelines", :module_detail_pointers_detail=>[]}, {:name=>"Map-Reduce Framework", :module_detail_pointers_detail=>[]}, {:name=>"Big Data", :module_detail_pointers_detail=>[]}, {:name=>"Data Warehousing & Modelling", :module_detail_pointers_detail=>[]}, {:name=>"OLAP, Dashboarding", :module_detail_pointers_detail=>[]}, {:name=>"Workflow Orchestration", :module_detail_pointers_detail=>[]}, {:name=>"Logging, and Monitoring", :module_detail_pointers_detail=>[]}, {:name=>"MapReduce, HiveQL, Presto", :module_detail_pointers_detail=>[]}, {:name=>"3 Projects", :module_detail_pointers_detail=>[]}], :read_next=>"Read Next: Advanced Electives"}}, {:label=>"", :name=>"Advanced Electives", :duration=>"1 Month", :content=>{:duration=>"1 Month", :module_detail_pointers=>[{:title=>"DSA for Competitive Programming", :module_detail_pointers_detail=>[]}, {:name=>"Combinatorics and Probability", :module_detail_pointers_detail=>[]}, {:name=>"Matrix exponentiation", :module_detail_pointers_detail=>[]}, {:name=>"Advanced Trees: Segment Tree, k-D Tree", :module_detail_pointers_detail=>[]}, {:name=>"Disjoint Set Union", :module_detail_pointers_detail=>[]}, {:name=>"Advanced Dynamic Programming", :module_detail_pointers_detail=>[]}, {:name=>"Advanced Graphs: Bridges, Articulation point, Network Flow ", :module_detail_pointers_detail=>[]}, {:choice=>"And/Or", :module_detail_pointers_detail=>[]}, {:title=>"Product Management for Engineers", :module_detail_pointers_detail=>[]}, {:name=>"Introduction to Product Management", :module_detail_pointers_detail=>[]}, {:name=>"Product Thinking & Product Discovery", :module_detail_pointers_detail=>[]}, {:name=>"Product Roadmap & Prioritization", :module_detail_pointers_detail=>[]}, {:name=>"Mental Models for Product Managers", :module_detail_pointers_detail=>[]}, {:name=>"Product Analytics", :module_detail_pointers_detail=>[]}, {:name=>"Hands-on case study & Mixpanel session", :module_detail_pointers_detail=>[]}, {:name=>"Delivery & Project Management", :module_detail_pointers_detail=>[]}, {:name=>"Practical ways to apply PM lessons as an Engineer", :module_detail_pointers_detail=>[]}], :read_prev=>"Read Prev: Module 1 - Advanced DSA and CS Fundamentals"}}]}]
        }
      )
