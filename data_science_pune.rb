class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
    def up
      ...
      Course.find_by(:slug => "data-science-course-training-in-pune")&.destroy
      content = {:metadata => {:jsonld => "true", :next_batch_details => {:course_slug => "ds", :course_type => "intermediate"}, :program => "data-science", :header => {:logo => "scaler/png/scaler-data-science.png", :path => "/data-science-course/", :logo_alt => "Scaler Data Science"}, 
                ...
                :banner => {:breadcrumb => [{:cta => "Home", :link => "https://www.scaler.com/"}, 
                    ...
                    {:cta => "<b>Data Science Course in Pune</b>"}], 
                    :heading => "<h1><b>Data Science Course in Pune</b></h1>", 
                    :content => ["Learn in-demand Data Science skills like Forecasting Analytics, Text Mining, Data Wrangling, Machine Learning Algorithms, Hadoop, Python and more.", 
                    "Embrace real-world business challenges by building portfolio-worthy projects", 
                    "Assured placement mentorship + Interactive sessions with Industry Experts as trainers"], 
                    :background_image => "course_page/banner/bannernew.png", 
                    :footer => "Next Batch Starts  ",
                    :title => "Enroll for our Data Science training course in Pune to advance your career opportunities"},
                :briefing => {:heading => "<h2>Why <b><span class=\"highlight\">Data Science?</span></b></h2>", 
                        :places => [{:className => "mc", :name => "<h3><b>What is Data Science?</b></h3>", :desc => "To put it simply, Data Science refers to 
                        the process of extracting actionable insights from raw data. Techniques, theories, and concepts from many different fields 
                        are applied, including mathematics, statistics, computer science, information science, and domain knowledge to extract 
                        insights from structured and unstructured data. Data Science provides a vast array of tools for working with data coming 
                        from a variety of different sources, such as financial logs, multimedia files, marketing forms, sensors, and text files."}, 
                        {:className => "mc", :name => "<h3><b>What does a Data Scientist do?</b></h3>", 
                        :desc => "A data scientist uses various methods, systems, algorithms, and processes to analyze data in order to generate 
                        actionable insights. A Data Scientist is a highly qualified professional with highly developed mathematical, 
                        statistical, scientific, analytical and technical skills who can prepare, clean, and validate structured and 
                        unstructured data for businesses to use to make better decisions. They provide insight that can illuminate a 
                        business's trajectory toward its long-term goals and can be a real change-maker within an organization. 
                        ...
                        the online Data Science training in Pune?</b></h3>", :desc => "Pune is one of India's 
                        premier industrial and educational centers. Pune is now entering the Data Science game, where large 
                        corporations and small to medium businesses are incorporating Data Science into their business strategies. 
                        In order to gain an in-demand set of skills required for today's job opportunities in Data Science, we offer 
                        the best Data Science training course in Pune. Some of the great career opportunities after completing a 
                        Data Science course in Pune include:
                ...
                :questions => {:heading => "<h2><b><span class = 'highlight'>Data Science Training</span> Course FAQs</b></h2>", 
                    ...
                    {:question => "What is eligibility for a Data Science course in Pune?", 
                    ...
                    Data Science online training course?", :answer => "Our curriculum for the Data Science Course will introduce you to concepts 
                    of Data Science tools, Data Science algorithms, and machine learning principles that will assist you in gaining some meaningful 
                    insights from unstructured data. During a Data Science training course, you will learn about various languages and tools, from Python 
                    to SQL, Deep learning, Machine Learning, Artificial Intelligence, Statistical Methods, data analysis, data wrangling, 
                    and Data Visualization."}, 
                    {:question => "What are the Career Opportunities or type of jobs that I will be suited for after 
                    completing this Data Scientist course in Pune?", :answer => "n Data Science, there are a variety of job roles that can be 
                    assigned depending on industry needs. Once you graduate from our Data Science course in Pune, you will possess an in-demand 
                    ...
                    you will be more likely to grow."}, {:question => "What important skills will you learn through this Data Scientist course in Pune?", 
                    ...
                    the key skills you learn with our Data Science program in Pune include statistical skills, mathematical skills, programming skills 
                    (Python, Java, etc.), Data mining skills, cloud computing skills (like AWS and others), ML skills (K-Nearest Neighbour, 
                    random forests, ensemble methods, support vector machines, etc.), database skills (SQL, NoSQL, etc.), etc."}, 
                    ...
                    chat messages.</li>"}, {:question => "Who should take this Data Science course in Pune?", 
                    :answer => "Professionals interested in advancing their careers with Data Science should take this Data Scientist course in Pune.
                    ...
                    <li>Business analysts</li>"}, {:question => "What is the Data Science career path in Pune?", 
                    :answer => "Pune has always been a strong academic hub as well as a flourishing tech hub. Three major sectors make up Pune's 
                    industrial core: IT, manufacturing, and automobiles. Pune is now entering the Data Science game, where large corporations and 
                    ...
                    in the Data Science field are vast and commendable in Pune. Our Data Science training course in Pune is designed to train students with 
                    ...
                    {:question => "What are the fees for the Data Science course in Pune?", 
                    :answer => "In Pune, the fee for the Data Science course is Rs. 2.99L inclusive of GST. EMI options are available. 
                ...
                :other_pages => {:heading => "<h2>Find Data Science <b><span class=\"highlight\">Course in other cities</span></b> below</h2>", 
                                        :list => [{:cta => "Data Science Course in Mumbai", 
                                        :link => "/courses/data-science-course-training-in-mumbai"}, 
