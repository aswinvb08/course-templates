class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
    def up
      ...
      Course.find_by(:slug => "data-science-course-training-in-hyderabad")&.destroy
      content = {:metadata => {:jsonld => "true", :next_batch_details => {:course_slug => "ds", :course_type => "intermediate"}, :program => "data-science", :header => {:logo => "scaler/png/scaler-data-science.png", :path => "/data-science-course/", :logo_alt => "Scaler Data Science"}, 
                ...
                :banner => {:breadcrumb => [{:cta => "Home", :link => "https://www.scaler.com/"}, 
                    ...
                    {:cta => "<b>Data Science Course in Hyderabad</b>"}], 
                    :heading => "<h1><b>Data Science Course in Hyderabad</b></h1>", 
                    :content => ["Learn in-demand Data Science skills like Deep Learning, Data Wrangling, AI, Python, Machine Learning, Spark, 
                    Hadoop, Airflow and more.", "Embrace real-world business challenges by building portfolio-worthy projects", 
                    "Personal placement guidance + Interactive sessions with Industry Experts"], 
                    :background_image => "course_page/banner/bannernew.png", 
                    :footer => "Next Batch Starts  ",
                    :title => "Improve your career prospects by enrolling in a Data Science training course in Hyderabad"},
                :briefing => {:heading => "<h2>Why <b><span class=\"highlight\">Data Science?</span></b></h2>", 
                        :places => [{:className => "mc", :name => "<h3><b>What is Data Science?</b></h3>", :desc => "Data Science is the process of obtaining 
                        actionable insights from raw data. With data science, organizations can make better business decisions by interpreting, 
                        modeling, and deploying data. There are numerous methods, algorithms, and processes used to extract insights from large 
                        amounts of data. Data Science provides a vast array of tools for working with data coming from a variety 
                        of different sources, such as financial logs, multimedia files, marketing forms, sensors, and text files."}, 
                        {:className => "mc", :name => "<h3><b>What does a Data Scientist do?</b></h3>", 
                        :desc => "A data scientist is someone who uses Data Science to analyze data and provide actionable insights 
                        by using various processes, methods, systems, and algorithms. Computer science, modeling, statistics, analytics, 
                        and math are the most common skills for these professionals, along with a keen business sense. Data scientists combine esoteric 
                        knowledge with practical insight, which makes them so valuable to a company. As a whole, they must fulfill several 
                        ...
                        the online Data Science training in Hyderabad?</b></h3>", :desc => "One of India's largest 
                        cities with a significant IT workforce, Hyderabad is considered to be an ideal place to 
                        start up a career in Data Science. As a matter of fact, many Data Science training centers 
                        are emerging in Hyderabad. In order to gain an in-demand set of skills required for today's 
                        job opportunities in Data Science, we offer the best Data Science training course in Hyderabad. 
                        Some of the great career opportunities after completing a Data Science course in Hyderabad include:
                        <li>Lead/Senior/Geospatial Data Scientist</li>  
                        <li>Forecasting Analyst, Research Analyst, Data Analytics</li>
                        <li>Analytics Lead/Consultant/Manager</li>  
                        <li>Machine Learning Engineer</li>
                        <li>Statistical Programming Specialist</li>
                        <li>Hadoop Developer, etc.</li>"}]},
                ...
                :questions => {:heading => "<h2><b><span class = 'highlight'>Data Science Training</span> Course FAQs</b></h2>", 
                    ...
                    Data Science online training course?", :answer => "Our curriculum for the Data Science Course will introduce you to 
                    concepts of Data Science tools, Data Science algorithms, and machine learning principles that will assist you in 
                    gaining some meaningful insights from unstructured data. During a Data Science training course, you will 
                    learn about various languages and tools, from Python to SQL, Deep learning, Machine Learning, Artificial 
                    Intelligence, Statistical Methods, data analysis, data wrangling, and Data Visualization."}, 
                    {:question => "What are the Career Opportunities or type of jobs that I will be suited for after 
                    completing this Data Scientist course in Hyderabad?", :answer => "In Data Science, there are a variety of job roles that 
                    can be assigned depending on industry needs. Once you graduate from our Data Science course in Hyderabad, you will 
                    possess an in-demand set of skills critical to today's Data Science career opportunities, which include: 
                    Lead/Senior/Geospatial Data Scientist, Forecasting Analyst, Research Analyst, Data Analytics, Analytics 
                    Lead/Manager/Consultant, Machine Learning Engineer, Statistical Programming Specialist, Hadoop Developer, 
                    and many more."}, {:question => "What kind of salary can I expect as a Data Science Professional?", 
                    ...
                    you will be more likely to grow."},{:question => "Who should take this Data Science course in Hyderabad?", :answer => "Professionals interested in 
                    advancing their careers with Data Science should take this Data Scientist course in Hyderabad.
                    ...
                    <li>Business analysts</li>"}, {:question => "What is the Data Science career path in Hyderabad?", 
                    :answer => "Hyderabad, one of India's most well-known IT hubs, is home to many companies developing Data Science. Many Data Science training centers are emerging in 
                    Hyderabad and as an IT hub, Hyderabad has evolved beyond people's expectations and is fiercely competing with Bengaluru. Therefore, job and growth prospects 
                    in the Data Science field are vast and commendable in Hyderabad. Our Data Science training course in Hyderabad is designed to 
                    train students with the in-demand skills they will need to succeed in today's job market. This course facilitates a deeper 
                    ...
                    course is Rs. 3.19L inclusive of GST. EMI options are available. Take the course for two weeks - if you decide to withdraw, you're fully 
                    refunded. If you opt for an EMI option, your monthly payment will be as low as Rs. 10,492."},
                    ...
                    technical interviews. Our instructors and mentors have extensive experience assisting 
                    candidates with behavioral interviews."},
                    {:question => "How many programming languages will I learn in this Data Science course in Hyderabad?", 
                    :answer => "You do not need to be a guru at coding to learn data science. Still, having a clear understanding 
                    of programming concepts would be helpful. While taking the data science course in Hyderabad, you will 
                    learn various programming languages that will help you get into the subject matter of data science. 
                    Python, Java, Javascript, R-programming, SQL, etc., are some of them. As a data scientist, it is 
                    imperative for you to master at least one language since it is used to accomplish a 
                    variety of data science functions."},
                    {:question => "Is Data Science course difficult to learn?", 
                    :answer => "Data Science jobs have more technical requirements, 
                    which can make learning more challenging than other technology fields. However, 
                    learning Data Science won't be difficult if you are motivated, passionate, and 
                    have the ability to deal with data. Developing data science skill or 
                    knowledge simply requires practice and time."}]},
