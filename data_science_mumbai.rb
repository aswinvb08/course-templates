class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
    def up
      ...
      Course.find_by(:slug => "data-science-course-training-in-mumbai")&.destroy
      content = {:metadata => {:jsonld => "true", :next_batch_details => {:course_slug => "ds", :course_type => "intermediate"}, :program => "data-science", :header => {:logo => "scaler/png/scaler-data-science.png", :path => "/data-science-course/", :logo_alt => "Scaler Data Science"}, 
                ...
                :banner => {:breadcrumb => [{:cta => "Home", :link => "https://www.scaler.com/"}, 
                    ...
                    {:cta => "<b>Data Science Course in Mumbai</b>"}], 
                    :heading => "<h1><b>Data Science Course in Mumbai</b></h1>", 
                    :content => ["Learn in-demand Data Science skills like Git and deploying models, Text Mining, Data Wrangling , Data Virtualization, Machine Learning, Python, PySpark, Spark, Hadoop, Airflow, and more", 
                    "Work on portfolio-worthy projects and practice your skills on real-world business problems", 
                    "1:1 Placement mentorship + Interactive sessions with top Industry Experts/Practitioners"], 
                    :background_image => "course_page/banner/bannernew.png", 
                    :footer => "Next Batch Starts  ",
                    :title => "Get the edge with our Data Science training course in Mumbai"},
                :briefing => {:heading => "<h2>Why <b><span class=\"highlight\">Data Science?</span></b></h2>", 
                        :places => [{:className => "mc", :name => "<h3><b>What is Data Science?</b></h3>", :desc => "In a nutshell, Data Science is the process 
                        of gaining actionable insights from raw data. Data is analyzed using a variety of scientific methods, algorithms, and processes. 
                        There are a wide range of tools available for processing data that comes from a variety of sources, including financial logs, 
                        multimedia files, marketing forms, sensors, and text files. Cleaning, aggregating, and manipulating data for advanced analyses 
                        are important aspects of Data Science. It is an interdisciplinary topic that combines programming skills, technical skills, 
                        ...
                        :desc => "A data scientist is someone who practices Data Science to analyze data so that they can provide actionable insights 
                        by using various processes, methods, systems, and algorithms. With expertise in a variety of data niches like mathematical, 
                        statistical, scientific, analytical and technical skillsdata scientists assist companies with the interpretation and management 
                        of data. Data Scientists help businesses make better decisions by preparing, cleaning, and validating structured and unstructured data. 
                        As a whole, they must fulfill several responsibilities, as follows:
                        ...
                        the online Data Science training in Mumbai?</b></h3>", :desc => "Mumbai is a city that is 
                        always up and always working. It has over 5000 companies located in its core. With its co-working 
                        spaces and soon-to-be unicorns, it will certainly play a key role in India's rapid IT growth. 
                        If you wish to begin a Data Science course in Mumbai, you will have the opportunity to embark on a fulfilling 
                        and rewarding career. In order to gain an in-demand set of skills required for today's job opportunities 
                        in Data Science, we offer the best Data Science training course in Mumbai. Some of the great career opportunities 
                        after completing a Data Science course in Mumbai include:
                ...
                :questions => {:heading => "<h2><b><span class = 'highlight'>Data Science Training</span> Course FAQs</b></h2>", 
                    ...
                    :answer => "Those who wish to learn Data Science, whether they are beginners or professionals, are welcome to 
                    enroll. Software, IT, and marketing professionals can enrol part-time or through external programs in Data Science."}, 
                    {:question => "What is eligibility for a Data Science course in Mumbai?", 
                    ...
                    {:question => "What will I learn in the 
                    Data Science online training course?", :answer => "Our curriculum for the Data Science Course will introduce you to concepts of Data 
                    Science tools, Data Science algorithms, and machine learning principles that will assist you in gaining some meaningful insights 
                    from unstructured data. During a Data Science training course, you will learn about various languages and tools, from Python to 
                    SQL, Deep learning, Machine Learning, Artificial Intelligence, Statistical Methods, data analysis, data wrangling, and Data Visualization."}, 
                    {:question => "What are the Career Opportunities or type of jobs that I will be suited for after 
                    completing this Data Scientist course in Mumbai?", :answer => "n Data Science, there are a variety of job roles that can be 
                    assigned depending on industry needs. Once you graduate from our Data Science course in Mumbai, you will possess an in-demand 
                    ...
                    you will be more likely to grow."}, {:question => "What important skills will you learn through this Data Scientist course in Mumbai?", 
                    :answer => "A Data Scientist must possess a wide range of skills and be knowledgeable about the tools and techniques involved. Some 
                    of the key skills you learn with our Data Science program in Mumbai include statistical skills, mathematical skills, programming 
                    skills (Python, Java, etc.), Data mining skills, cloud computing skills (like AWS and others), ML skills 
                    (K-Nearest Neighbour, random forests, ensemble methods, support vector machines, etc.), database skills (SQL, NoSQL, etc.), etc."}, 
                    ...
                    chat messages.</li>"}, {:question => "Who should take this Data Science course in Mumbai?", 
                    :answer => "Professionals interested in advancing their careers with Data Science should take this Data Scientist course in Mumbai.
                    ...
                    <li>Business analysts</li>"}, {:question => "What is the Data Science career path in Mumbai?", 
                    :answer => "Mumbai has always been a strong academic hub as well as a flourishing tech hub. Three major sectors make up Mumbai's 
                    industrial core: IT, manufacturing, and automobiles. Mumbai is now entering the Data Science game, where large corporations and 
                    ...
                    in the Data Science field are vast and commendable in Mumbai. Our Data Science training course in Mumbai is designed to train students with 
                    ...
                    {:question => "What are the fees for the Data Science course in Mumbai?", 
                    :answer => "In Mumbai, the fee for the Data Science course is Rs. 2.99L inclusive of GST. EMI options are available. 
                    Take the course for two weeks - if you decide to withdraw, you're fully refunded. If you opt for an EMI option, 
                    your monthly payment will be as low as Rs. 9,811."}]},
