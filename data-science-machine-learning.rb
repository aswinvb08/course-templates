class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
    def up
      ...
      Course.find_by(:slug => "data-science-machine-learning-course")&.destroy
      content = {:metadata => {:jsonld => "true", :next_batch_details => {:course_slug => "ds", :course_type => "intermediate"}, :program => "data-science", :header => {:logo => "scaler/png/scaler-data-science.png", :path => "/data-science-course/"}, 
                ...
                :banner => {:heading => "<h1><b>A rigorous and industry-approved
                    Data Science and Machine Learning Program</b></h1>", 
                ...
                :briefing => {:heading => "<h2>Why <b><span class=\"highlight\">Data Science?</span></b></h2>", 
                    ...
                    {:className => "mc", :name => "<h3><b>Why should you take up the online Data Science and Machine Learning training?</b></h3>", 
                    :desc => "Globally, data scientists are the most sought-after, in-demand profession and almost all industries 
                    are actively hiring Data Scientists, so obtaining a Data Science certification is highly recommended. As India 
                    is home to several tech companies, the Data Science field offers vast and promising career opportunities. 
                    In this fast-growing field, we offer a  Data Science training course designed for beginners and professionals. After you complete this Data science course, you will have an in-demand set of skills that are critical to today's career opportunities in:
