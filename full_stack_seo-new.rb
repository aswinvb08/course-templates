class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
  def up
    ...
    content.merge!(:academy_curriculum => 
      ...
      content.merge!(:tuition_fee => {:heading => "<b>Full Stack Development Course Fee<b>", :title_img => "academy/svg/money-logo.svg", :subtitle => "Total fee: Rs 3.69L inclusive of GST at super affordable EMI options. Try the course for the first 2 weeks - full money-back guarantee if you choose to withdraw.", :title_content => "With scholarship & EMI options, your payment can be as low as Rs. 8,628 per month - that's like your monthly 
      ...
      content.merge!(:questions => {:heading => "<h2><b><span class = 'highlight'>Full Stack Web Development</span> Course FAQs</b></h2>", 
                          ...
                          :answer => "The total tuition fee including GST is INR 3.59. With EMI, this can drop as low as ~INR 8,628/month (equivalent to your monthly grocery bill!)"},
