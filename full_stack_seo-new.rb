class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
  def up
    ...
    content = {:metadata => {:program => "academy", :header => nil, :links => [{:url => "#curriculum", :text => "Curriculum"}, 
              ...
              {:url => "#faq", :text => "FAQ"}]}}
    content.merge!(:banner => {:heading => "<b>Become a Full Stack Developer with Scaler Academy Program</b>", 
    ...
    content.merge!(:briefing => {:heading => "Why <b>Full <span class=\"highlight\">Stack Web Development?</span></b>", 
    ...
    content.merge!(:glance => {:heading => "<span class='highlight'>Key highlights</span> of the Scaler Academy's Full 
    ...
    content.merge!(:academy_curriculum => 
                ...
                content.merge!(:people => {:heading => "Gain confidence in <b>Full Stack concepts</b>, taught by <span class=\"highlight\"><b>experienced instructors</b></span>", 
            ...
            content.merge!(:testimonials => {:heading => "Our success <span class=\"highlight\">lies in our learners'</span> success stories.", :sub_title => "Read the reviews by Scaler Alumni on how Scaler Academy Program has helped become solid developers", 
      ...
      content.merge!(:tuition_fee => {:heading => "<b>Tuition Fee<b>", :title_img => "academy/svg/money-logo.svg", :subtitle => "Total fee: Rs. 2.5L inclusive of GST. You also get scholarships upto Rs. 25,000 and super affordable EMI options.
