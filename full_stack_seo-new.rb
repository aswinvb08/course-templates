class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
  def up
    ...
    content = {:metadata => {:program => "academy", :header => nil, :links => [{:url => "#curriculum", :text => "Curriculum"}, 
              ...
              {:url => "#faq", :text => "FAQ"}]}}
    content.merge!(:banner => {:heading => "<h1><b>Become a Full Stack Developer with Scaler Academy Program</b></h1>", 
    ...
    content.merge!(:briefing => {:heading => "<h2>Why <b>Full <span class=\"highlight\">Stack Web Development?</span></b></h2>", 
