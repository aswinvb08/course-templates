class AddCoursesSeoPageContent < ActiveRecord::Migration[5.1]
  def up
    ...
    content = {:metadata => {:program => "academy", :header => nil, :links => [{:url => "#curriculum", :text => "Curriculum"}, 
              ...
              {:url => "#faq", :text => "FAQ"}]}, 
          :banner => {:heading => "<b>Become a Full Stack Developer with Scaler Academy Program</b>", 
              :content => ["Upskill in <b>DSA & System Design</b> with specialization in Full Stack Development", 
                  ...
                  :glance => {:heading => "<span class='highlight'>Key highlights</span> of the Scaler Academy's Full 
                      Stack Specialization program", "sub_heading"=>"Scaler Academy's full-stack development program 
                      ...
                      :cards => [{:img => "academy/svg/at-a-glance/structured.svg", :title => "<b>Structured, industry-vetted curriculum</b>"}, {:img => "academy/svg/at-a-glance/live-classes.svg", :title => "<b>Live classes by faculty</b> who have been there, done that"}, 
                          ...
                          {:img => "course_page/svg/Aspirational-Network.svg", :title => "<b>Aspirational peer group</b> of 2,000+ Scaler students & alumni"}, {:img => "course_page/svg/Career-Support.svg", 
                              ...
                              :partners => {:heading => "<span class=\"highlight\">Scaler <b>alumni</b> work</span> at reputed <b>tech organizations</b> and <b>promising startups</b>", :companies => ["google", "amazon", "microsoft", "adobe", "mindtickle", "flipkart", "goldman", "walmart", "myntra", 
                          ...
                          :testimonials => {:heading => "Our success <span class=\"highlight\">lies in our learners'</span> success stories.", :sub_title => "Read the reviews by Scaler Alumni on how Scaler Academy Program has helped become solid developers", 
                      ...
                      :join => {:heading => "Connect with an Academic Counsellor", :button => [{:id => "request_callback__one", :text => "REQUEST A CALLBACK", :link => ""}]}, 
                      :tuition_fee => {:heading => "<b>Tuition Fee<b>", :title_img => "academy/svg/money-logo.svg", :subtitle => "Total fee: Rs. 2.5L inclusive of GST. You also get scholarships upto Rs. 25,000 and super affordable EMI options.
                          Try the course for the first 2 weeks - full money-back guarantee if you choose to withdraw.", :title_content => "With scholarship & EMI options, your payment can be as low as Rs. 7,200 per month - that's like your monthly 
                          grocery bill!", :buttons => [{:id => "tuition_modal_one", :text => "VIEW EMI PLANS", :link => ""}, {:id => "tuition_modal_two", :text => "SCHOLARSHIP DETAILS", :link => ""}]}, 
                      :faq => {:main => [{:heading => "Program", :list => [{:heading => "<b>What is Scaler Academy?</b>", :desc => "Scaler Academy offers a structured, flexible and guided learning program for software engineers 
                          ...
                          {:heading => "Tuition Fee", :list => [{:heading => "<b>What is the total tuition fee?</b>", :desc => "The total tuition fee including GST is INR 2.5L. With EMI, this can drop as low as ~INR 7,200/month (equivalent to your monthly grocery bill!)"}, 
                          {:heading => "<b>Are there scholarships?</b>", :desc => "Yes!<br><b>Way of getting exciting scholarships at Scaler Academy</b><br><b>Get up to INR 25,000 as scholarship basis your performance in the 30 minutes entrance test! If you secure the scholarship and also opt for EMI payment, 
                          then you can pay as little as INR 7,200 per month to sign up for Scaler Academy!</b>"}, 
